    ...
    try {
      ...
      try {
        ...
        return res.json({
          ...
          methodologyHeading: fallback.methodologyHeading,
          methodologyPara1: fallback.methodologyPara1,
          methodologyPara2: fallback.methodologyPara2,
          isBrowseOnly: fallback.isBrowseOnly,
