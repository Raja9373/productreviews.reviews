...
export const CountdownScanner: React.FC<CountdownScannerProps> = ({
  ...
  const steps = [
    {
      icon: ShoppingBag,
      title: 'Synthesizing verified purchaser feedback...',
      desc: 'Filtering recurring owner sentiment and long-term reliability reports',
      color: 'text-amber-500',
      bgColor: 'bg-amber-50',
    },
    {
      icon: Youtube,
      title: 'Analyzing teardowns & expert video evaluations...',
      desc: 'Extracting thermal, hardware, and real-life stress test data',
      color: 'text-red-500',
      bgColor: 'bg-red-50',
    },
    {
      icon: MessageSquare,
      title: 'Checking community discussions & forum feedback...',
      desc: 'Aggregating independent user experience and real-world durability',
      color: 'text-orange-500',
      bgColor: 'bg-orange-50',
    },
    {
      icon: ShieldCheck,
      title: 'Evaluating technical benchmarks & specifications...',
      desc: 'Assessing build quality, energy efficiency, and value ratio',
      color: 'text-blue-500',
      bgColor: 'bg-blue-50',
    },
    {
      icon: Tag,
      title: 'Formulating decision matrix & buying options...',
      desc: 'Structuring final bottom-line recommendation and verified retailer options',
