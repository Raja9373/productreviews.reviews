...
import { Globe, Search, ChevronDown, Check, Zap, Sparkles, MapPin } from 'lucide-react';
import { LanguageCode, LanguageDef } from '../types';
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-5 shadow-2xl border border-zinc-200 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="text-zinc-600 hover:text-zinc-600 text-sm font-semibold p-1"
              >
                ✕
              </button>
            </div>
