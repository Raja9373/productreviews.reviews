...
export const TRANSLATIONS: Record<LanguageCode, LocaleTranslations> = {
  ...
  ja: {
    siteTitle: 'ProductReviews.review',
    tagline: 'グローバル検索＆意思決定エンジン',
    headline: '検索。比較。決定。',
    supportingText: '本物の事実と検証されたレビューに基づき、最適な選択肢をご提案します。',
    ...
    strengths: 'メリット',
    drawback: 'デメリット',
    whoItIsFor: 'こんな人におすすめ',
    priceUnverified: '価格未確認 — 販売元でご確認ください',
    checkPrice: '価格を確認',
    viewDetails: '詳細を見る',
    visitOfficial: '公式サイトへ',
    contact: '問い合わせ',
    book: '予約する',
    sourcesLabel: '公式ソース＆検証元',
    comparisonVs: 'VS',
    comparisonFactors: '比較ポイント',
    verdict: '結論＆評価',
    mainCompromise: '主な注意点',
    noResultsTitle: '該当する結果が見つかりませんでした',
    noResultsDesc: '架空のデータやレビューは一切作成しません。',
    marketLabel: '国 / 地域',
    languageLabel: '言語',
    affiliateNotice: 'Amazonアソシエイト・プログラム参加者として、適格販売により収入を得ています。',
    footerAbout: '会社概要',
    footerContact: 'お問い合わせ',
    footerPrivacy: 'プライバシーポリシー',
    footerTerms: '利用規約',
    footerAffiliate: 'アフィリエイト情報',
    backToHome: '検索に戻る',
  },
};
