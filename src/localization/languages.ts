...
export const TRANSLATIONS: Record<LanguageCode, LocaleTranslations> = {
  en: {
    ...
    book: 'Book Now',
    sourcesLabel: 'Verified References',
    comparisonVs: 'VS',
    comparisonFactors: 'Key Decision Factors',
    verdict: 'Decision Verdict',
    mainCompromise: 'Main Compromise',
    noResultsTitle: 'We couldn’t verify suitable results for this search',
    noResultsDesc:
  ...
  es: {
    ...
    noResultsTitle: 'No pudimos verificar resultados adecuados para esta búsqueda',
    noResultsDesc:
  ...
  it: {
    ...
    noResultsTitle: 'Nessun risultato verificato per questa ricerca',
  ...
  fr: {
    ...
    noResultsTitle: 'Aucun résultat vérifiable trouvé pour cette recherche',
